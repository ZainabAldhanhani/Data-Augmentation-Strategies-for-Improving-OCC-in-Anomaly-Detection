...
# 3. OCGAN training for MVTec AD
def train_ocgan_mvtec(root, epochs=20, batch_size=32, lr=2e-4):
    ds = MVTecDataset(root, phase='train', transform=default_transform)
...
# 4. Evaluation for MVTec AD
def evaluate_ocgan_mvtec(E, G, root, batch_size=32):
    ds = MVTecDataset(root, phase='test', transform=default_transform)
