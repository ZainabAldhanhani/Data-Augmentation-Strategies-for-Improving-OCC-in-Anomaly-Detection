...
def main(dataset_path):
    ...
    # Display original training and testing frames
    ...
    # Generate and display some Fourier Domain augmented training frames
    fourier_images = []
    num_samples = 5
    ...
    # ------------------------------------------------------------------------------
    # Concatenate ground truth labels and anomaly scores
    ...
    # Compute F1 Score using the optimal threshold
