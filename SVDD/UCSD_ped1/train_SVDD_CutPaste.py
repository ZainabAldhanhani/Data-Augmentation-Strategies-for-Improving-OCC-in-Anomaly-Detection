...
def main(dataset_path):
    ...
    # Source: Kaggle (https://www.kaggle.com/datasets/tapakah68/ucsd-anomaly-detection-dataset) cite
    ...
    # patch from an image and pasting it to another location. It is inspired by the ideas
    # discussed in the paper "CutPaste: Self-Supervised Learning for Anomaly Detection and Localization"
    # (https://arxiv.org/abs/2203.06516) cite
    ...
    # Generate and display some CutPaste augmented training frames
    augmented_images = []
    num_samples = 5
    for i in range(num_samples):
        # Squeeze to remove the channel dimension for augmentation and later reshape back if needed
    ...
    plot_images(np.array(augmented_images).reshape(-1, 200, 200, 1), "CutPaste Augmented Frames", n=5)
