...
from scipy.ndimage import gaussian_filter, map_coordinates  # For elastic deformations
...
def main(dataset_path):
    ...
    # Dataset Loading
    # ------------------------------------------------------------------------------
    # Dataset: UCSD Anomaly Detection Dataset (Ped1)
    # Source: Kaggle (https://www.kaggle.com/datasets/tapakah68/ucsd-anomaly-detection-dataset) :contentReference[oaicite:1]{index=1}
    ...
    # ------------------------------------------------------------------------------
    # The elastic_transform function applies deformable augmentation by applying a random displacement field,
    # smoothed with a Gaussian filter. This technique is based on the method proposed by Simard et al. (2003)
    # for elastic distortions, which has been widely used for data augmentation in computer vision.
    # Reference: [Simard et al., 2003](https://ieeexplore.ieee.org/document/1234858) :contentReference[oaicite:2]{index=2}
